...
namespace Escc.EastSussexGovUK.Umbraco.Web.Tests
{
    ...
    public class NuGetIncludedFilesCorrectlyTests
    {
        ...
        [TestCase(@"Views\Shared\_RecyclingSiteFinder.cshtml")]
	...
	[TestCase(@"App_Plugins\EditorTools\Views\CSVExport\Index.cshtml")]
        ...
        public void NuGetPackagesCorrectlyIncludedInProject(string filePathWhichShouldBeIncluded)
        {
            ...
            var reader = new XPathDocument(Path.Combine(commonParent.FullName, @"escc.eastsussexgovuk.umbraco.web\escc.eastsussexgovuk.umbraco.web.csproj"));
