<%@ Control language="c#" Codebehind="FormDownloadPage.ascx.cs" AutoEventWireup="True" Inherits="Escc.EastSussexGovUK.Umbraco.Views.FormDownloadPage" EnableViewState="false" %>
    ...
    <div class="text">
        ...
        <p id="privacy" runat="server">Your personal details are protected when using our online forms. Read our <a href="/about/privacypolicy/default.htm">privacy statement</a>.</p>
    </div>
