...
namespace Escc.EastSussexGovUK.Umbraco.Views.Topic
{
    ...
    public partial class TopicSection_FeaturedImage : TopicSection
    {
        /// <summary>
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            this.subtitle.ID += SectionLayoutManager.ParsePlaceholderNumber(this.PlaceholderToBindSubtitle);
