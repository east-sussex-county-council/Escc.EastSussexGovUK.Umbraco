<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TopicSection_Normal.ascx.cs" Inherits="Escc.EastSussexGovUK.Umbraco.Views.Topic.TopicSection_Normal" %>

<div id="image1" runat="server" class="topicImageOdd"><div><div><div><div><div><div><div>
...
<div id="image2" runat="server" class="topicImageOdd"><div><div><div><div><div><div><div>
...
<div id="image3" runat="server" class="topicImageOdd"><div><div><div><div><div><div><div>
