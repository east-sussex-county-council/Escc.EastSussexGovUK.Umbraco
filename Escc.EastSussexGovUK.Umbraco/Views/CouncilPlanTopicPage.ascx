...
<div class="content text-content">
    ...
    <div class="plan-content">    
        <div class="columns" id="columns" runat="server">
            <div class="column column1" id="column1" runat="server">
                ...
                <div class="additional_content" runat="server" id="additional_content">
                    ...
                    <CmsPlaceholders:RichHtmlPlaceholderControl runat="server" PlaceholderToBind="phDefCaption09" EditControlHeight="200" ID="phCaption09" CssClass="caption" ElementName="div" />
                    ...
                    <CmsPlaceholders:RichHtmlPlaceholderControl runat="server" PlaceholderToBind="phDefCaption10" EditControlHeight="200" ID="phCaption10" CssClass="caption" ElementName="div" />
                    ...
                    <CmsPlaceholders:RichHtmlPlaceholderControl runat="server" PlaceholderToBind="phDefCaption11" EditControlHeight="200" ID="phCaption11" CssClass="caption" ElementName="div" />
                    ...
                    <CmsPlaceholders:RichHtmlPlaceholderControl runat="server" PlaceholderToBind="phDefCaption12" EditControlHeight="200" ID="phCaption12" CssClass="caption" ElementName="div" />
                    ...
                    <CmsPlaceholders:RichHtmlPlaceholderControl runat="server" PlaceholderToBind="phDefCaption13" EditControlHeight="200" ID="phCaption13" CssClass="caption" ElementName="div" />
                    ...
                    <CmsPlaceholders:RichHtmlPlaceholderControl runat="server" PlaceholderToBind="phDefCaption14" EditControlHeight="200" ID="phCaption14" CssClass="caption" ElementName="div" />
                    ...
                    <CmsPlaceholders:RichHtmlPlaceholderControl runat="server" PlaceholderToBind="phDefCaption15" EditControlHeight="200" ID="phCaption15" CssClass="caption" ElementName="div" />
        ...
        <div class="images" runat="server" id="images">
            ...
            <CmsPlaceholders:RichHtmlPlaceholderControl runat="server" PlaceholderToBind="phDefCaption05" EditControlHeight="200" ID="RichHtmlPlaceholderControl1" CssClass="caption" ElementName="div" />

            <CmsPlaceholders:XhtmlImagePlaceholderControl runat="server" PlaceholderToBind="phDefImage06" ID="image2" />
            <CmsPlaceholders:RichHtmlPlaceholderControl runat="server" PlaceholderToBind="phDefCaption06" EditControlHeight="200" ID="RichHtmlPlaceholderControl2" CssClass="caption" ElementName="div" />

            <CmsPlaceholders:XhtmlImagePlaceholderControl runat="server" PlaceholderToBind="phDefImage07" ID="image3" />
            <CmsPlaceholders:RichHtmlPlaceholderControl runat="server" PlaceholderToBind="phDefCaption07" EditControlHeight="200" ID="RichHtmlPlaceholderControl3" CssClass="caption" ElementName="div" />

            <CmsPlaceholders:XhtmlImagePlaceholderControl runat="server" PlaceholderToBind="phDefImage08" ID="image4" />
            <CmsPlaceholders:RichHtmlPlaceholderControl runat="server" PlaceholderToBind="phDefCaption08" EditControlHeight="200" ID="RichHtmlPlaceholderControl4" CssClass="caption" ElementName="div" />
