...
{
    /// <summary>
    /// An Umbraco document type for a park or open space, which gets most of its properties from the base <see cref="Escc.CustomerFocusTemplates.Website.DocumentTypes.Location"/> data type
    /// </summary>
