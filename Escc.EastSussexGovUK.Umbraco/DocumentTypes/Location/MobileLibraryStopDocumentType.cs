...
{
    /// <summary>
    /// An Umbraco document type for a mobile library stop, which gets most of its properties from the base <see cref="Escc.CustomerFocusTemplates.Website.DocumentTypes.Location"/> data type
    /// </summary>
