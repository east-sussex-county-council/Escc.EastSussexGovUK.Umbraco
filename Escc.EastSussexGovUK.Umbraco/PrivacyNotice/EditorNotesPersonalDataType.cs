...
namespace Escc.EastSussexGovUK.Umbraco.PrivacyNotice
{
    ...
    /// </summary>
    [UmbracoDataType(DataTypeName, PropertyEditor, typeof(EditorNotesPersonalDataType), DataTypeDatabaseType.Nvarchar)]
    public class EditorNotesPersonalDataType : IPreValueProvider
    {
