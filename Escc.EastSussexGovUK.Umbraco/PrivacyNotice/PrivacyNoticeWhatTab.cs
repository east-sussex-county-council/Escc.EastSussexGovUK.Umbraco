...
namespace Escc.EastSussexGovUK.Umbraco.PrivacyNotice
{
    ...
    description: "'This privacy notice covers...' - Explain who this privacy notice applies to and in what context.", sortOrder: 3)]
        public string WhatIsCovered { get; set; }

        [UmbracoProperty("Editor notes: Examples", "EditorNotesExamples", PrivacyNoticeExamplesDataType.PropertyEditor, PrivacyNoticeExamplesDataType.DataTypeName, sortOrder: 1)]
        public string EditorNotesExamples { get; set; }

        [UmbracoProperty("What is personal data?", "EditorNotesPersonalData", PrivacyNoticePersonalDataType.PropertyEditor, PrivacyNoticePersonalDataType.DataTypeName, sortOrder: 2)]
        ...
        [UmbracoProperty("What personal data is being used?", "WhatIsUsed", PropertyEditorAliases.RichTextPropertyEditor, RichTextEsccWithFormattingDataType.DataTypeName, mandatory: true,
            description: "'In order to provide the service, we will collect...' - list the data being processed, eg name, address, details of services being received, ethnicity etc.", sortOrder: 3)]
