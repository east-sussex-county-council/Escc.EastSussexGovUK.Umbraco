...
namespace Escc.EastSussexGovUK.Umbraco.Web.HomePage
{
    ...
    public class HomePageController : RenderMvcController
    {
        ...
        public async new Tasks.Task<ActionResult> Index(RenderModel model)
        {
            ...
            var viewModel = new HomePageViewModelFromUmbraco(model.Content, new RelatedLinksService(new RemoveMediaDomainUrlTransformer(), new RemoveAzureDomainUrlTransformer())).BuildModel();
            ...
            viewModel.RecyclingSiteSearch.WasteTypes.Insert(0, "Anything");
