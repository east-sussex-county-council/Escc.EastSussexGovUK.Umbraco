...
namespace Escc.EastSussexGovUK.Umbraco.Web.Forms
{
    ...
    class FileFromBlobStorageResult : ActionResult
    {
        ...
        public override void ExecuteResult(ControllerContext context)
        {
            ...
            blockBlob.DownloadToStream(context.HttpContext.Response.OutputStream);

            context.HttpContext.Response.ContentType = MimeMapping.GetMimeMapping(Path.GetExtension(blobPath));
