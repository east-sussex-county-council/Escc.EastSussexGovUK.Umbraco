<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StandardLandingPage.ascx.cs" Inherits="Escc.EastSussexGovUK.Umbraco.Web.Views.StandardLandingPage" %>
<%@ Register TagPrefix="Cms" Namespace="Escc.EastSussexGovUK.Umbraco.Web.MicrosoftCmsMigration" Assembly="Escc.EastSussexGovUK.Umbraco.Web" %>
